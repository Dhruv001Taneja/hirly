...
export default function SignInEmployerPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("[v0] Employer sign in:", formData)
    setIsSubmitted(true)
    setTimeout(() => {
    ...
    <div className="min-h-screen bg-gradient-to-b from-background to-muted/20 flex items-center justify-center px-4 py-8">
      <div className="w-full max-w-md">
        ...
        <Card className="p-8 border border-border">
          ...
          <h1 className="text-3xl font-bold text-foreground mb-2">Job Giver Sign In</h1>
          <p className="text-muted-foreground mb-8">Sign in to post jobs and manage applications</p>
          ...
          {!isSubmitted ? (
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <Button
                type="submit"
                className="w-full bg-secondary hover:bg-secondary/90 text-secondary-foreground h-10 font-medium"
              >
                Sign In
              </Button>
            </form>
            ...
            <div className="text-center">
              ...
              <p className="text-muted-foreground">Redirecting to employer dashboard...</p>
            </div>
          )}
